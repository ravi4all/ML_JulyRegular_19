...
user_1 = {"baahubali","zero","kgf","hulk","avengers","dhamaal","ms dhoni",
        "annabelle","conjuring","sanju","sixth sense","stree","thor"}

user_2 = {"avengers","dhamaal","ms dhoni","conjuring","stree",
          "superman","mary kom","thor","kgf","hulk"}

sim = user_1.intersection(user_2)
print("Similar movies :",sim)
score = {}
for key in database:
